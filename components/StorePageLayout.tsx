  ...
  return (
    <div className="bg-black text-white font-sans overflow-x-hidden min-h-screen">
      ...
      <main className="pt-32 sm:pt-40 lg:pt-52 text-center px-4" role="main">
        <h1
          className={`${ltcBroadway.className} text-4xl sm:text-5xl font-bold mb-6 text-pink-500`}
        >
          {title}
        </h1>
        ...
        <div
          className="flex flex-col md:flex-row justify-center items-center md:items-end gap-8 md:gap-32"
          role="region"
