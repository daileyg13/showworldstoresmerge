...
export default function HomePage() {
  ...
  return (
    <div className="bg-black text-white font-sans overflow-x-hidden">
      ...
      <section className="flex flex-col items-center justify-center text-center min-h-[80vh] bg-gradient-to-br from-zinc-900 to-zinc-800 px-4 mt-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {categories.map(({ title, img }) => (
            <Card key={title}>
              <CardContent className="p-6 flex flex-col items-center text-center">
                <img src={img} alt={title} className="rounded-lg mb-4 w-full object-cover h-80 neon-glow" style={{ animationDelay: `${Math.random() * 5}s` }} />
